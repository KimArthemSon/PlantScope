...
export default function LayerAssessmentList() {
  ...
  const handleCreateNew = () => {
    ...
    if (layerId === "meta_data") {
      ...
      router.push({
        pathname: path,
        params: { areaId, layerId, layerName, isEdit: "false" },
      });
    }
  };
    ...
    if (layerId === "meta_data") {
      ...
      router.push({
        ...
        params: {
          ...
          layerId,
          layerName,
          assessmentId: a.field_assessment_id.toString(),
          isEdit: "true",
        },
      });
    }
  ...
  const getLayerStatus = (
    ...
    if (
      layerData &&
      (layerData.overall_note || Object.keys(layerData).length > 0)
    ) {
      return "draft";
    }
    return "pending";
          ...
          <View style={styles.cardBody}>
            ...
            <View style={styles.cardTopRow}>
              ...
              >
                <Ionicons
                  name={
                    item.is_submitted ? "checkmark-circle" : "create-outline"
                  }
                  size={12}
            ...
            <View style={styles.metaRow}>
              ...
              {item.is_submitted && (
                <>
                  <Text style={styles.metaDot}>·</Text>
                  <Text style={styles.metaText}>
                    Submitted {fmtDate(item.updated_at)}
                  </Text>
                </>
              )}
            </View>
