...
export default function TermsAndConditions() {
  ...
  return (
    <View style={styles.root}>
      {/* Header with dynamic top padding to clear the status bar */}
      ...
      >
        ...
        <Section title="PREAMBLE">
          <Text style={styles.body}>
            These Terms and Conditions govern the access, registration, and use
            of <Text style={styles.bold}>PLANTSCOPE</Text> — a GIS-Based Site
            Suitability Assessment and Reforestation Monitoring System developed
            by students of the{" "}
        ...
        <Section title="SECTION 1: SCOPE AND PURPOSE OF SYSTEM USE">
          <SubSection title="1.1 Scope">
            <Text style={styles.body}>
              These Terms and Conditions apply to all individuals who access,
              register, or use PLANTSCOPE in any capacity, including:
            </Text>
            <BulletItem
              label="City ENRO Head (The Head)"
              text="— primary authority for reforestation program oversight and LGU staff account authorization and audit trails"
            />
            <BulletItem
              label="Data Manager (System Administrator)"
              text="— maintains technical and data integrity, oversees archive management"
            />
            <BulletItem
              label="GIS Specialists"
              text="— perform technical site suitability validation and manage spatial data"
            />
            <BulletItem
              label="Onsite Inspectors"
              text="— collect and submit field assessment data through the mobile application"
            />
            <BulletItem
              label="Community Users (Tree Growers)"
              text="— register for the Public Tree Planting Program and submit planting progress updates"
            />
          </SubSection>
          ...
          <SubSection title="1.2 Purpose">
            ...
            <PurposeCard
              ...
              body="Identify, evaluate, and validate suitable tree planting locations through NDVI pre-screening and MCDA."
            />
            <PurposeCard
              title="Field Data Collection"
              body="Enable Onsite Inspectors to collect structured field observations, safety indicators, soil data, GPS coordinates, and geotagged photographs via the mobile application."
            />
            <PurposeCard
              title="Reforestation Monitoring"
              body="Track post-planting progress, tree survival rates, and maintenance activities for validated reforestation sites."
            />
            <PurposeCard
              title="Community Engagement"
              body="Facilitate participation of schools, organizations, and groups in the Public Tree Planting Program."
            />
            <PurposeCard
              title="Archive Data Management"
              body="Oversee storage, restoration, and permanent deletion of records in accordance with government retention policies."
            />
            <PurposeCard
              title="Compliance & Audit"
              body="Maintain immutable audit trails and versioned site_data records for accountability and evidence-based environmental governance."
            />
          </SubSection>
          ...
          <SubSection title="1.3 Non-Commercial Use">
            <Text style={styles.body}>
              ...
              management system developed as an academic capstone project. It
              shall not be used for commercial gain, private business
              operations, or activities outside the environmental mandate of the
              Ormoc City LGU.
            </Text>
          </SubSection>
        </Section>
        ...
        <Section title="SECTION 2: USER RESPONSIBILITIES AND ACCEPTABLE USE">
          <SubSection title="2.1 General Responsibilities of All Users">
            <BulletItem
              ...
              text="Users are solely responsible for maintaining the confidentiality of their login credentials. Unauthorized use of a user account must be reported immediately to the Data Manager."
            />
            <BulletItem
              label="Accuracy of Information"
              text="All data, records, and submissions must be accurate, truthful, and complete. Submission of false, fabricated, or misleading information is strictly prohibited."
            />
            <BulletItem
              label="Role Compliance"
              text="Users must access and use only the features and data authorized for their assigned role."
            />
            <BulletItem
              label="System Integrity"
              text="Users must not perform any action that compromises the integrity, availability, or security of the PLANTSCOPE system."
            />
            <BulletItem
              label="Compliance with Laws"
              text="Users must comply with all applicable Philippine laws, including RA 10173, RA 7160, environmental protection laws, and civil service regulations."
            />
          </SubSection>
        ...
        <Section title="SECTION 3: PROHIBITED ACTIVITIES">
          <Text style={styles.body}>
            ...
            Violation may result in immediate account suspension, referral to
            appropriate authorities, and legal action under applicable
            Philippine laws.
          </Text>
          <ProhibitedCard
            number="01"
            title="Unauthorized Access"
            body="Accessing, attempting to access, or gaining entry to any account, data record, GIS layer, or system feature not authorized for your assigned role."
          />
          <ProhibitedCard
            number="02"
            title="Credential Sharing & Impersonation"
            body="Sharing or transferring your login credentials to any other person. Logging into the system using another user's credentials."
          />
          <ProhibitedCard
            number="03"
            title="Submission of False Data"
            body="Entering or submitting data that is knowingly false, fabricated, or deliberately misleading — including falsified field observations, fake GPS coordinates, or manipulated photographs."
          />
          <ProhibitedCard
            number="04"
            title="Unauthorized Data Extraction"
            body="Copying, exporting, or transmitting personal data, spatial records, or government maps to unauthorized individuals or external platforms."
          />
          <ProhibitedCard
            number="05"
            title="System Tampering"
            body="Introducing malicious code, performing denial-of-service attacks, SQL injection, or any form of technical interference that disrupts the system."
          />
          <ProhibitedCard
            number="06"
            title="Unauthorized Modification/Deletion"
            body="Modifying, overwriting, or deleting any system record without proper authority. The Data Manager may only archive or delete records per approved retention policies."
          />
          <ProhibitedCard
            number="07"
            title="Misuse of Personal Data"
            body="Using personal data accessed through PLANTSCOPE for any purpose other than those explicitly stated in these Terms and the Data Privacy Notice."
          />
          <ProhibitedCard
            number="08"
            title="Use Outside Authorized Scope"
            body="Using PLANTSCOPE for activities beyond its stated environmental management and reforestation functions."
          />
          <View style={styles.legalWarning}>
            ...
            <Text style={styles.legalBody}>
              ...
              (Anti-Graft), and other applicable Philippine laws. The Ormoc City
              LGU reserves the right to refer violations to the National Privacy
              Commission, law enforcement, or other competent bodies.
            </Text>
          </View>
        </Section>
        ...
        <Section title="SECTION 5: ACCOUNT MANAGEMENT AND ACCESS CONTROL">
          ...
          <SubSection title="5.2 Account Suspension and Termination">
            <Text style={styles.body}>
              ...
              to suspend or permanently deactivate any user account under the
        ...
        <Section title="SECTION 6: LIMITATION OF LIABILITY">
          <LiabilityCard
            ...
            body='PLANTSCOPE is provided on an "as-is" and "as-available" basis. The development team and Western Leyte College of Ormoc City make no warranty that the system will operate without interruption, error, or defect at all times.'
          />
          <LiabilityCard
            title="6.2 No Liability for User-Submitted Data"
            body="The system does not automatically verify the accuracy of user-submitted data. The PLANTSCOPE development team shall not be liable for decisions made based on inaccurate, incomplete, or false data submitted by users."
          />
          <LiabilityCard
            title="6.3 Data Manager Accountability"
            body="The Data Manager bears institutional responsibility for the proper administration of system records and audit trails. Unauthorized manipulation of records by the Data Manager constitutes a serious violation of these Terms and applicable law."
          />
          <LiabilityCard
            title="6.4 LGU Operational Liability"
            body="The Ormoc City LGU, acting through City ENRO and CPDO, assumes operational responsibility for the deployed PLANTSCOPE system and for decisions made based on its outputs."
          />
          <LiabilityCard
            title="6.5 Force Majeure"
            body="Neither the system developer nor the LGU shall be held liable for any failure to perform obligations caused by circumstances beyond reasonable control, including natural disasters, acts of war, or government-mandated system shutdowns."
          />
        </Section>
        ...
        <Section title="SECTION 7: COMPLIANCE WITH RA 10173 – DATA PRIVACY ACT OF 2012">
          <Text style={styles.body}>
            PLANTSCOPE is designed and operated in full compliance with Republic
            Act No. 10173 and its IRR, as enforced by the National Privacy
            Commission (NPC) of the Philippines.
          </Text>
          <PurposeCard
            title="Transparency"
            body="Users are informed of all data collection and processing through the PLANTSCOPE Data Privacy Notice, issued alongside these Terms."
          />
          <PurposeCard
            title="Legitimate Purpose"
            body="Personal data is collected exclusively for reforestation management, field monitoring, community engagement, and audit functions of the Ormoc City LGU."
          />
          <PurposeCard
            title="Proportionality"
            body="Only the minimum personal data necessary for each role's functions is collected. GPS coordinates are optional."
          />
          <PurposeCard
            title="Data Security"
            body="Technical and organizational security measures are implemented including encryption, RBAC, and immutable audit trails managed by the Data Manager."
          />
          <PurposeCard
            title="Data Subject Rights"
            body="All registered users retain their rights under Chapter IV of RA 10173, exercisable through the Data Manager or the LGU DPO."
          />
          <PurposeCard
            title="Data Retention & Disposal"
            body="Data is retained per the schedules in the PLANTSCOPE Data Privacy Notice and disposed of securely by the Data Manager upon expiration."
          />
          <Text style={styles.note}>
            These Terms and Conditions must be read in conjunction with the
            PLANTSCOPE Data Privacy Notice. In matters of data privacy, the Data
            Privacy Notice shall prevail.
          </Text>
        </Section>
        ...
        <Section title="SECTION 8: ACCEPTANCE OF TERMS AND CONDITIONS">
          <Text style={styles.body}>
            By accessing or using PLANTSCOPE, you expressly confirm and agree to
            the following:
          </Text>
          <View style={styles.acceptanceBox}>
            ...
            <Text style={styles.acceptanceText}>
              ...
              and consent to the collection, processing, and use of my personal
            ...
            <Text style={styles.acceptanceText}>
              4. I understand that violation of these Terms and Conditions may
              result in account suspension, termination, and legal consequences
              under applicable Philippine law.
            </Text>
            <Text style={styles.acceptanceText}>
              5. I affirm that all information I provide to the system is
              accurate, truthful, and complete, and I accept full responsibility
              for the data I submit.
            </Text>
            <Text style={styles.acceptanceText}>
              6. I acknowledge that PLANTSCOPE is a government-deployed
              environmental management system and commit to using it exclusively
        ...
        <Section title="SECTION 9: GOVERNING LAW AND JURISDICTION">
          <Text style={styles.body}>
            ...
            Republic of the Philippines, including RA 10173, RA 10175, RA 7160,
            RA 3019, and NPC Circulars. Any dispute shall be subject to the
            jurisdiction of the appropriate government agencies and courts, with
            venue in <Text style={styles.bold}>Ormoc City, Leyte</Text>.
          </Text>
        </Section>
...
const styles = StyleSheet.create({
  ...
  content: {
    padding: 20,
    // paddingBottom is handled dynamically via inline style using insets.bottom
  },
  mainTitle: {
    fontSize: 24,
    fontWeight: "700",
