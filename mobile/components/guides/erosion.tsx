...
const allImages: GuideImage[] = [
  { id: "safe1", source: safeErosion1, category: "safe", label: "Safe Erosion" },
  { id: "safe2", source: safeErosion2, category: "safe", label: "Safe Erosion" },
  { id: "safe3", source: safeErosion3, category: "safe", label: "Safe Erosion" },
  { id: "danger1", source: dangerErosion1, category: "danger", label: "Danger Erosion" },
  { id: "danger2", source: dangerErosion2, category: "danger", label: "Danger Erosion" },
  { id: "danger3", source: dangerErosion3, category: "danger", label: "Danger Erosion" },
];
