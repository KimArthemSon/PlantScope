  ...
  return (
    ...
    >
      ...
      <div className="flex items-start justify-between mb-3">
        <div
          className={`w-10 h-10 rounded-xl flex items-center justify-center ${color.replace("bg-", "bg-").replace("-500", "")}/10`}
...
export default function Dashboard() {
  ...
  const checkIfStillLogin = async () => {
    ...
    try {
      ...
      if (response.ok && !(data.user_role === "CityENROHead"))
    ...
    <>
      ...
      <div className="dash-root bg-[#f5faf6] min-h-screen p-6 overflow-x-hidden">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-5 mb-5">
            ...
            <div className="flex items-center justify-between mb-5">
              <div>
                <h2 className="dash-title text-[15px] font-bold text-gray-800">
                  Monitoring Progress vs Target
                </h2>
                <p className="text-[12px] text-gray-400 mt-0.5">
                  Jan – Jul 2024 • All active sites
                </p>
              </div>
              ...
              <AreaChart data={MONITORING_DATA}>
                <defs>
                  ...
                  <linearGradient id="targGrad" x1="0" y1="0" x2="0" y2="1">
                    <stop offset="5%" stopColor="#0F4A2F" stopOpacity={0.1} />
          ...
          >
            <h2 className="dash-title text-[15px] font-bold text-gray-800 mb-1">
              Annual Goal
            </h2>
            <p className="text-[12px] text-gray-400 mb-4">
              Trees planted vs 25,000 target
            </p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-5 mb-5">
          ...
          >
            <div className="flex items-center justify-between mb-5">
              <div>
                <h2 className="dash-title text-[15px] font-bold text-gray-800">
                  Species — Planted vs Survived
                </h2>
                <p className="text-[12px] text-gray-400 mt-0.5">
                  Cumulative across all sites
                </p>
              </div>
            </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-5">
          ...
          >
            ...
            <p className="text-[12px] text-gray-400 mb-4">
              Monthly average across all sites
            </p>
          ...
          >
            <h2 className="dash-title text-[15px] font-bold text-gray-800 mb-4">
                ...
                <div key={s.name} className="flex items-center gap-3">
                  ...
                  <div className="flex-1">
                    <div className="h-2 rounded-full bg-gray-100 overflow-hidden">
                      <div
                        className={`h-full rounded-full transition-all duration-700 ${HEALTH_COLOR(s.health)}`}
                  ...
                  <span
                    className={`text-[10px] font-semibold px-2 py-0.5 rounded-full border ${STATUS_BADGE[s.status] ?? "bg-gray-50 text-gray-600 border-gray-200"}`}
                  >
                    {s.status}
                  </span>
                </div>
              ...
              {RECENT_ACTIVITIES.map((a) => {
                ...
                return (
                  <div key={a.id} className="flex items-start gap-3 group">
                    <div
                      className={`mt-0.5 w-7 h-7 rounded-lg flex items-center justify-center shrink-0 ${s.bg} ${s.text}`}
                    >
                      {s.icon}
                    </div>
