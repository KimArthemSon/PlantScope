  ...
  if (action === "confirm") {
    return (
      <div className="p-4 bg-green-50 border border-green-200 rounded-xl space-y-3">
        ...
        <ul className="text-sm text-green-800 space-y-1.5 ml-6 list-disc">
          <li>
  ...
  return (
    <div className="p-4 bg-red-50 border border-red-200 rounded-xl space-y-3">
      <div className="flex items-center gap-2 text-red-700">
        <XCircle size={16} />
        <span className="font-semibold">Upon Rejection:</span>
      </div>
      <ul className="text-sm text-red-800 space-y-1.5 ml-6 list-disc">
        <li>
          Application status changes to <strong>Rejected</strong>
        </li>
        <li>
          Tree grower account remains <strong>inactive</strong>
        </li>
        <li>Applicant will be notified of the decision</li>
        <li>Application can be resubmitted after corrections</li>
      </ul>
    </div>
  );
}
      ...
      <header className="bg-gradient-to-r from-[#0F4A2F] to-[#1a6b44] text-white px-6 py-5 shadow-lg sticky top-0 z-40">
        <div className="max-w-6xl mx-auto flex items-center gap-4">
          ...
          <div className="flex items-center gap-2.5 min-w-0">
            <Leaf size={22} className="text-green-300 flex-shrink-0" />
              ...
              <div key={i} className="flex items-center gap-2">
                <button
                  ...
                  className={`flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-semibold transition-all ${
                    tab === i
                      ? "bg-white text-[#0F4A2F] shadow-sm"
        ...
        {TABS.map((t, i) => (
          <button
            ...
            className={`flex-1 py-3 text-xs font-semibold flex flex-col items-center gap-1 transition-colors ${
              tab === i
                ? "text-[#0F4A2F] border-b-2 border-[#0F4A2F]"
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              <div className="flex flex-col gap-5">
                <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
                  <SectionHeader
                    icon={<Shield size={18} />}
                    title="Data Manager's Evaluation"
                    subtitle="Application approved and forwarded for your confirmation"
                  />

                  <InfoRow
                    label="Current Status"
                    children={
                      <span className="px-2.5 py-1 rounded-full text-xs font-medium bg-blue-100 text-blue-700 flex items-center gap-1.5">
                        <Clock size={12} /> Pending Head Confirmation
                      </span>
                    }
                  />
                  ...
                  {latest_reason?.reason && (
                    <div className="mt-4">
                      <p className="text-xs font-semibold text-gray-400 uppercase tracking-wide mb-2">
                        Remarks from Data Manager
                      </p>
                      <div className="p-3 bg-gray-50 rounded-xl border border-gray-100 text-sm text-gray-700 whitespace-pre-wrap leading-relaxed">
                        {latest_reason.reason}
                      </div>
              ...
              <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 flex flex-col">
                <SectionHeader
                  ...
                  title="Your Decision"
                  subtitle="Confirm or reject this application"
                />
              ...
              <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
                ...
                <div className="flex gap-3 w-full sm:w-auto">
                  ...
                  <button
                    ...
                    disabled={submitting}
                    className="flex items-center gap-2 border border-red-200 text-red-500 px-5 py-2.5 rounded-xl text-sm font-bold hover:bg-red-50 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                    type="button"
                  >
                  ...
                  <button
                    ...
                    disabled={submitting}
                    className="flex items-center gap-2 bg-[#0F4A2F] text-white px-6 py-2.5 rounded-xl text-sm font-bold hover:bg-[#1a6b44] transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                    type="button"
                  >
