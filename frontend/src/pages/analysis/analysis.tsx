...
export default function Analysis() {
  ...
  const pieData = [
    { name: "Needs Planting", value: sites.filter((s) => s.status === "Needs Planting").length },
    { name: "Healthy", value: sites.filter((s) => s.status === "Healthy").length },
    { name: "Degraded", value: sites.filter((s) => s.status === "Degraded").length },
  ];
    ...
    <div className="flex h-screen overflow-hidden">
      ...
      <main className="flex-1 bg-gray-50 p-6 overflow-y-auto">
        ...
        <div className="flex justify-between items-center mb-4">
          <h1 className="text-3xl font-bold text-[#052e87]">🌍 Analysis & Results</h1>
          <button
        ...
        <p className="text-gray-600 mb-4 max-w-3xl">
          This module consolidates AI & GIS results for all reforestation sites. It shows which areas require planting,
          maintenance, or are healthy based on vegetation, moisture, and erosion indicators.
        </p>
              ...
              >
                <Popup>
                  <div className="text-sm">
                    ...
                    Soil Moisture: {site.soilMoisture}<br />
                    Erosion Risk: {site.erosionRisk}<br />
                    <button
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
          ...
          <div className="bg-white rounded-xl shadow-md p-6 border">
            <h2 className="text-lg font-semibold text-[#052e87] mb-4">Overall Site Status</h2>
          ...
          {/* Bar Chart */}
          <div className="bg-white rounded-xl shadow-md p-6 border">
            <h2 className="text-lg font-semibold text-[#052e87] mb-4">Vegetation Coverage by Site (%)</h2>
            <ResponsiveContainer width="100%" height={250}>
          ...
          <table className="min-w-full text-sm text-left border-collapse">
            ...
            <tbody>
              {filteredSites.map((site, index) => (
                <tr key={site.id} className="hover:bg-gray-50 border-b last:border-none transition">
