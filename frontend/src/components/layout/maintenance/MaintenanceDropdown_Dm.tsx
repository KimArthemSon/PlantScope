...
export default function MaintenanceDropdown_Dm({
  expanded,
  maintenanceOpen,
  setMaintenanceOpen,
        ...
        <div className="mt-2 ml-6 space-y-1">
          ...
          <Link
            ...
            className={`
              flex items-center gap-3 px-4 py-3 text-[.75rem] rounded-md
              ${
                location.pathname === "/DataManager/maintenance/barangays"
                  ? "bg-white/20 text-white"
                  : "text-white/70 hover:bg-white/10 hover:text-white"
              }
            `}
          ...
          <Link
            to="/DataManager/maintenance/tree-species"
            className={`
              flex items-center gap-3 px-4 py-3 text-[.75rem] rounded-md
              ${
                location.pathname === "/DataManager/maintenance/tree-species"
                  ? "bg-white/20 text-white"
                  : "text-white/70 hover:bg-white/10 hover:text-white"
              }
            `}
          ...
          <Link
            to="/DataManager/maintenance/soils"
            className={`
              flex items-center gap-3 px-4 py-3 text-[.75rem] rounded-md
              ${
                location.pathname === "/DataManager/maintenance/soils"
                  ? "bg-white/20 text-white"
                  : "text-white/70 hover:bg-white/10 hover:text-white"
              }
            `}
          ...
          <Link
            ...
            className={`
              ...
              ${
                location.pathname ===
                "/DataManager/maintenance/land-classification"
                  ? "bg-white/20 text-white"
                  : "text-white/70 hover:bg-white/10 hover:text-white"
              }
            `}
